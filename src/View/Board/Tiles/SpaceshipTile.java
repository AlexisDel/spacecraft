...
public class SpaceshipTile extends ItemTile {
    ...
    public void draw(Graphics2D g, int tileSize, int displayX, int displayY) {
        ...
        g.drawImage(ImageManager.spaceShipTile, (item.getCoordinate().x-displayX)*tileSize, (item.getCoordinate().y-displayY)*tileSize, item.getDimension().width*tileSize, item.getDimension().height*tileSize, null);
