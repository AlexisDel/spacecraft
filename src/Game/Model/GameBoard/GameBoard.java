package Game.Model.GameBoard;

import Game.Model.GameConstants;
import Game.Model.GameElements.Layer0.Mountain;
import Game.Model.GameElements.Layer1.Entities.Actions.AlienMovements;
...
import static Game.Model.GameConstants.*;
...
public class GameBoard {
     ...
     */
    public GameBoard() {
        mountains = new RandomLandGenerator().getBoard();
