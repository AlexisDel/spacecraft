...
public class SpaceMarinePanel extends JPanel {
    private String[] description= {"A legendary intergalactic hero you control.", "SpaceMarines are world conquerers.","Their mission is to get all the rocks.","Achieve this goal by ANY means!"};
